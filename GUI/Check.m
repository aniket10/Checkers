...
if Checker(Xnew,Ynew)==1
  if (Xnew>=0 && Xnew<8 && Ynew>=0 && Ynew<8)
    if (Checker(Xnew+1,Ynew+1)==0), 
        Button=0;
    end
  end
  
  if (Xnew>=0 && Xnew<8 && Ynew>1 && Ynew<=0)
    if (Checker(Xnew+1,Ynew-1)==0), 
        Button=0;
    end
  end
  ...
  if (Xnew>=0 && Xnew<=6 && Ynew>=0 && Ynew<=6)
    if (Checker(Xnew+2,Ynew+2)==0 && Checker(Xnew+1,Ynew+1)==2 || Checker(Xnew+1,Ynew+1)==4), 
        Button=0;    
    end
  end
...
if Checker(Xnew,Ynew)==2,
  ...
  if (Xnew>=3 && Xnew<=8 && Ynew>=0 && Ynew<=6)
    if (Checker(Xnew-2,Ynew+2)==0 && Checker(Xnew-1,Ynew+1)==1 || Checker(Xnew-1,Ynew+1)==3), 
        Button=0;    
    end
  end
